...
$(TEST_EDIT_REGEX_TARGET): $(SRC) $(TEST_EDIT_REGEX_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_EDIT_REGEX_TARGET) $(BUILD_DIR)/claude_test.o $(BUILD_DIR)/test_edit_regex.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_READ_TARGET): $(SRC) $(TEST_READ_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_READ_TARGET) $(BUILD_DIR)/claude_read_test.o $(BUILD_DIR)/test_read.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_TODO_WRITE_TARGET): $(SRC) $(TEST_TODO_WRITE_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_TODO_WRITE_TARGET) $(BUILD_DIR)/claude_todowrite_test.o $(BUILD_DIR)/test_todo_write.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_BASH_TIMEOUT_TARGET): $(SRC) $(TEST_BASH_TIMEOUT_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_BASH_TIMEOUT_TARGET) $(BUILD_DIR)/claude_bash_timeout_test.o $(BUILD_DIR)/test_bash_timeout.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_BASH_STDERR_TARGET): $(SRC) $(TEST_BASH_STDERR_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_BASH_STDERR_TARGET) $(BUILD_DIR)/claude_bash_stderr_test.o $(BUILD_DIR)/test_bash_stderr.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_BASH_TRUNCATION_TARGET): $(SRC) $(TEST_BASH_TRUNCATION_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_BASH_TRUNCATION_TARGET) $(BUILD_DIR)/claude_bash_truncation_test.o $(BUILD_DIR)/test_bash_truncation.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_PROVIDER_INIT_FROM_CONFIG_TARGET): $(SRC) tests/test_provider_init_from_config.c $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_PROVIDER_INIT_FROM_CONFIG_TARGET) $(BUILD_DIR)/claude_provider_test.o $(BUILD_DIR)/test_provider_init_from_config.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_PROVIDER_INIT_TARGET): $(SRC) tests/test_provider_init.c $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_PROVIDER_INIT_TARGET) $(BUILD_DIR)/provider_init_test.o $(BUILD_DIR)/test_provider_init.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_TOOL_RESULTS_REGRESSION_TARGET): $(SRC) $(TEST_TOOL_RESULTS_REGRESSION_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_TOOL_RESULTS_REGRESSION_TARGET) $(BUILD_DIR)/claude_tool_results_test.o $(BUILD_DIR)/test_tool_results_regression.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_MODEL_SWITCH_INTERACTIVE_TARGET): $(SRC) $(TEST_MODEL_SWITCH_INTERACTIVE_SRC) $(TEST_COMMON_OBJS)
	...
	@$(CC) -o $(TEST_MODEL_SWITCH_INTERACTIVE_TARGET) \
		...
		$(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_OPENAI_RESPONSE_PARSING_TARGET): $(SRC) $(TEST_OPENAI_RESPONSE_PARSING_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_OPENAI_RESPONSE_PARSING_TARGET) $(BUILD_DIR)/claude_openai_response_test.o $(BUILD_DIR)/test_openai_response_parsing.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_CANCEL_FLOW_TARGET): $(SRC) tests/test_cancel_flow.c $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_CANCEL_FLOW_TARGET) $(BUILD_DIR)/klawed_cancel_flow_test.o $(BUILD_DIR)/test_cancel_flow.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_WRITE_DIFF_INTEGRATION_TARGET): $(SRC) $(TEST_WRITE_DIFF_INTEGRATION_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_WRITE_DIFF_INTEGRATION_TARGET) $(BUILD_DIR)/claude_write_diff_test.o $(BUILD_DIR)/test_write_diff_integration.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_FUNCTION_CONTEXT_TARGET): $(SRC) $(TEST_FUNCTION_CONTEXT_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_FUNCTION_CONTEXT_TARGET) $(BUILD_DIR)/claude_function_context_test.o $(BUILD_DIR)/test_function_context.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_EVENT_LOOP_TARGET): $(SRC) $(TEST_EVENT_LOOP_SRC) $(TEST_STUBS_SRC) $(TEST_COMMON_OBJS)
	...
	@$(CC) $(CFLAGS) -Wno-unused-function -o $(TEST_EVENT_LOOP_TARGET) $(BUILD_DIR)/claude_event_loop_test.o $(TEST_EVENT_LOOP_SRC) $(TEST_STUBS_SRC) $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_SQLITE_QUEUE_SEEDING_TARGET): $(SRC) $(TEST_SQLITE_QUEUE_SEEDING_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_SQLITE_QUEUE_SEEDING_TARGET) $(BUILD_DIR)/klawed_sqlite_queue_seeding_test.o $(BUILD_DIR)/test_sqlite_queue_seeding.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
