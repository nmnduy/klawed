...
$(PROVIDER_OBJ): $(PROVIDER_SRC) src/provider.h src/openai_provider.h src/bedrock_provider.h src/anthropic_provider.h src/deepseek_provider.h src/moonshot_provider.h src/openai_responses_provider.h src/logger.h
	@mkdir -p $(BUILD_DIR)
