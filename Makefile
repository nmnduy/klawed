...
$(TEST_EDIT_TARGET): $(SRC) $(TEST_EDIT_SRC) $(TEST_COMMON_OBJS)
	...
	@$(CC) -o $(TEST_EDIT_TARGET) $(BUILD_DIR)/claude_test.o $(BUILD_DIR)/test_edit.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(SSE_PARSER_OBJ) $(STREAMING_TOOL_ACCUMULATOR_OBJ) $(OPENAI_STREAMING_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_READ_TARGET): $(SRC) $(TEST_READ_SRC) $(TEST_COMMON_OBJS)
	...
	$(BUILD_TOOL_SYSTEM_TEST_OBJS)
	@echo "Linking test executable..."
	@$(CC) -o $(TEST_READ_TARGET) $(BUILD_DIR)/claude_read_test.o $(BUILD_DIR)/test_read.o $(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(SSE_PARSER_OBJ) $(STREAMING_TOOL_ACCUMULATOR_OBJ) $(OPENAI_STREAMING_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
...
$(TEST_MODEL_SWITCH_INTERACTIVE_TARGET): $(SRC) $(TEST_MODEL_SWITCH_INTERACTIVE_SRC) $(TEST_COMMON_OBJS)
	...
	@$(CC) -o $(TEST_MODEL_SWITCH_INTERACTIVE_TARGET) \
		...
		$(SQLITE_QUEUE_TEST_OBJ) $(TOOL_REGISTRY_TEST_OBJ) $(TOOL_EXECUTOR_TEST_OBJ) $(TOOL_DEFINITIONS_TEST_OBJ) $(DYNAMIC_TOOLS_TEST_OBJ) $(CRASH_HANDLER_OBJ) $(SSE_PARSER_OBJ) $(STREAMING_TOOL_ACCUMULATOR_OBJ) $(OPENAI_STREAMING_OBJ) $(TEST_COMMON_OBJS) $(LDFLAGS)
	@echo ""
