...
API_TIMING_SRC = src/api/api_timing.c
API_TIMING_OBJ = $(BUILD_DIR)/api_timing.o
...
$(BUILD_DIR)/api_timing.o: $(API_TIMING_SRC) src/api/api_timing.h
	@mkdir -p $(BUILD_DIR)
	$(CC) $(CFLAGS) -c -o $(BUILD_DIR)/api_timing.o $(API_TIMING_SRC)
