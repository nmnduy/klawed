...
> **Status**: Migration complete — all phases done (v2.0.0-zig)  
...
- [x] Replace `Makefile` with thin shim calling `zig build`
- [x] Update `KLAWED.md` with Zig coding standards and new quick-start commands
- [x] Update all `docs/` references that mention C, `gcc`, `make`, `libbsd`, etc.
