...
#define KLAWED_VERSION_NUMBER 0x000110

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2025-12-29"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.1.16 (built 2025-12-29)"
