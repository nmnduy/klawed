...
#define KLAWED_VERSION_NUMBER 0x002304

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-06-20"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.35.4 (built 2026-06-20)"
