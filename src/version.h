...
#define KLAWED_VERSION_NUMBER 0x002401

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-07-06"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.36.1 (built 2026-07-06)"
