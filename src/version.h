...
#define KLAWED_VERSION_NUMBER 0x001e0c

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-02-28"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.30.12 (built 2026-02-28)"
