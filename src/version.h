...
#define KLAWED_VERSION_NUMBER 0x000c04

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-01-11"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.12.4 (built 2026-01-11)"
