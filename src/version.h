...
#define KLAWED_VERSION_NUMBER 0x002307

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-06-23"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.35.7 (built 2026-06-23)"
