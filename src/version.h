...
#define KLAWED_VERSION_NUMBER 0x001e0d

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-03-01"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.30.13 (built 2026-03-01)"
