...
#define KLAWED_VERSION_NUMBER 0x001101

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-01-18"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.17.1 (built 2026-01-18)"
