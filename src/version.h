...
#define KLAWED_VERSION_NUMBER 0x001d0e

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-02-18"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.29.14 (built 2026-02-18)"
