...
#define KLAWED_VERSION_NUMBER 0x002300

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-06-17"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.35.0 (built 2026-06-17)"
