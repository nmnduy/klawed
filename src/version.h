...
#define KLAWED_VERSION_NUMBER 0x00200e

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-03-25"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.32.14 (built 2026-03-25)"
