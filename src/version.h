...
#define KLAWED_VERSION_NUMBER 0x002420

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-08-04"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.36.32 (built 2026-08-04)"
