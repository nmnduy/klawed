...
#define KLAWED_VERSION_NUMBER 0x001600

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-01-27"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.22.0 (built 2026-01-27)"
