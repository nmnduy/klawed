...
#define KLAWED_VERSION_NUMBER 0x000c01

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-01-10"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.12.1 (built 2026-01-10)"
