...
#define KLAWED_VERSION_NUMBER 0x00230a

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-07-01"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.35.10 (built 2026-07-01)"
