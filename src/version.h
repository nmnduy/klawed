...
#define KLAWED_VERSION_NUMBER 0x002022

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-04-07"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.32.34 (built 2026-04-07)"
