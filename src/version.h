...
#define KLAWED_VERSION_NUMBER 0x00240a

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-07-13"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.36.10 (built 2026-07-13)"
