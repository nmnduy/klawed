...
#define KLAWED_VERSION_NUMBER 0x000501

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-01-04"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.5.1 (built 2026-01-04)"
