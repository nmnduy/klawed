...
#define KLAWED_VERSION_NUMBER 0x001d03

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-02-15"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.29.3 (built 2026-02-15)"
