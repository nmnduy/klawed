...
#define KLAWED_VERSION_NUMBER 0x001c17

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-02-11"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.28.23 (built 2026-02-11)"
