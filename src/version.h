...
#define KLAWED_VERSION_NUMBER 0x00190e

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-02-05"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.25.14 (built 2026-02-05)"
