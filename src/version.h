...
#define KLAWED_VERSION_NUMBER 0x001d0c

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-02-17"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.29.12 (built 2026-02-17)"
