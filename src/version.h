...
#define KLAWED_VERSION_NUMBER 0x00240c

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-07-14"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.36.12 (built 2026-07-14)"
