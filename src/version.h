...
#define KLAWED_VERSION_NUMBER 0x001d08

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-02-16"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.29.8 (built 2026-02-16)"
