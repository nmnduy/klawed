...
#define KLAWED_VERSION_NUMBER 0x001912

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-02-06"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.25.18 (built 2026-02-06)"
