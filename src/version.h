...
#define KLAWED_VERSION_NUMBER 0x00241a

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-07-30"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.36.26 (built 2026-07-30)"
