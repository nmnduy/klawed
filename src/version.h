...
#define KLAWED_VERSION_NUMBER 0x00240d

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-07-16"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.36.13 (built 2026-07-16)"
