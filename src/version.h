...
#define KLAWED_VERSION_NUMBER 0x002305

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-06-21"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.35.5 (built 2026-06-21)"
