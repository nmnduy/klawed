...
#define KLAWED_VERSION_NUMBER 0x002003

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-03-21"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.32.3 (built 2026-03-21)"
