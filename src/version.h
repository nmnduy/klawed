...
#define KLAWED_VERSION_NUMBER 0x001d16

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-02-22"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.29.22 (built 2026-02-22)"
