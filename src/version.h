...
#define KLAWED_VERSION_NUMBER 0x002008

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-03-23"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.32.8 (built 2026-03-23)"
