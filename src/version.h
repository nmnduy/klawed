...
#define KLAWED_VERSION_NUMBER 0x00241f

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-08-02"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.36.31 (built 2026-08-02)"
