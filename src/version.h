...
#define KLAWED_VERSION_NUMBER 0x00241e

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-07-31"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.36.30 (built 2026-07-31)"
