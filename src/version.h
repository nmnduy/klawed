...
#define KLAWED_VERSION_NUMBER 0x002309

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-06-29"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.35.9 (built 2026-06-29)"
