...
#define KLAWED_VERSION_NUMBER 0x002303

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-06-19"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.35.3 (built 2026-06-19)"
