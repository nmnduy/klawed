...
#define KLAWED_VERSION_NUMBER 0x001107

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-01-19"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.17.7 (built 2026-01-19)"
