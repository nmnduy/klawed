...
#define KLAWED_VERSION_NUMBER 0x00200d

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-03-24"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.32.13 (built 2026-03-24)"
