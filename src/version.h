...
#define KLAWED_VERSION_NUMBER 0x00201e

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-04-05"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.32.30 (built 2026-04-05)"
