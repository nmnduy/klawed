...
#define KLAWED_VERSION "0.12.7"

// Version components for programmatic use
#define KLAWED_VERSION_MAJOR 0
#define KLAWED_VERSION_MINOR 12
#define KLAWED_VERSION_PATCH 7

// Version as numeric value for comparisons (e.g., 0x000002)
#define KLAWED_VERSION_NUMBER 0x000c07

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-01-12"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.12.7 (built 2026-01-12)"
