...
#define KLAWED_VERSION_NUMBER 0x001e12

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-03-03"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.30.18 (built 2026-03-03)"
