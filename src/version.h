...
#define KLAWED_VERSION_NUMBER 0x001e1b

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-03-06"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.30.27 (built 2026-03-06)"
