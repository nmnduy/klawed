...
#define KLAWED_VERSION_NUMBER 0x000803

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-01-06"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.8.3 (built 2026-01-06)"
