...
#define KLAWED_VERSION_NUMBER 0x001401

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-01-25"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.20.1 (built 2026-01-25)"
