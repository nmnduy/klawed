...
#define KLAWED_VERSION_NUMBER 0x00201a

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-04-01"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.32.26 (built 2026-04-01)"
