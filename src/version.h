...
#define KLAWED_VERSION_NUMBER 0x001f02

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-03-13"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.31.2 (built 2026-03-13)"
