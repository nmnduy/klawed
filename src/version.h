...
#define KLAWED_VERSION_NUMBER 0x002422

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-08-10"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.36.34 (built 2026-08-10)"
