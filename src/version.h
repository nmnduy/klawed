...
#define KLAWED_VERSION_NUMBER 0x002417

// Build timestamp (automatically generated)
#define KLAWED_BUILD_TIMESTAMP "2026-07-28"

// Full version string with build info
#define KLAWED_VERSION_FULL "0.36.23 (built 2026-07-28)"
