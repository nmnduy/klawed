...
pub fn build(b: *std.Build) void {
    ...
    // ---------------------------------------------------------------------------
    // Primary executable — "klawed" (pure Zig)
    // ---------------------------------------------------------------------------
    // Phase 10: C source tree has been deleted.  The primary binary is now the
    // Zig-native implementation built from zig/main.zig.
    ...
    // Link libraries needed by the zig/ modules.
